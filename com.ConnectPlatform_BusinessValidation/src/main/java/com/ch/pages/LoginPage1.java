...
public class LoginPage1 extends TestBase{
	...
	@FindBy(css="#editUserRole")
	public
	WebElement edituserrole;
	
	@FindBy(css="#role_2_Physician")
	public WebElement physician;
	
	@FindBy(xpath="/html[1]/body[1]/div[10]/div[2]/div[1]/div[2]/ul[1]/li[10]")
	public WebElement physicianassistant;
	
	@FindBy(xpath="//input[@id='role_28_Nurse Practitioner']")
	public WebElement nursepractictioner;
	
	@FindBy(xpath="//input[@id='role_1_Pharmacist']")
	public WebElement pharmacist;
	
	@FindBy(css="#saveRoles")
	public WebElement saveroles;
	...
	public void state_inputdata1() {
		Select select=new Select(state);
	    List<WebElement> abc=select.getOptions();
	...
	public void choosepassword(String uname) throws InterruptedException {
		String password = "Pas5w@rd" + RandomStringUtils.randomNumeric(1);
		
		System.out.println( "username is:" + uname + " password is:" + password );
		registerpassword.sendKeys(password);
		
		registerconfpwd.sendKeys(password);
		//System.out.println( pwd );
		/*
		 * char[] possibleCharacters = (new String(
		 * "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789~`!@#$%^&*()-_=+[{]}\\|;:\'\",<.>/?"
		 * )).toCharArray(); String randomStr = RandomStringUtils.random( 8, 0,
		 * possibleCharacters.length-1, false, false, possibleCharacters, new
		 * SecureRandom() ); System.out.println( randomStr );
		 * registerpassword.sendKeys(randomStr + "01"); Thread.sleep(1000);
		 * registerconfpwd.sendKeys(randomStr + "01");
		 */
	}
	...
	public void cnfirmpassword() {
		...
		registerpassword.sendKeys(randomStr);
	}
	...
	public void register_inputdetails() throws InterruptedException {
	...
	public void register_inputdetails1() throws IOException, InterruptedException {
	...
	public void register_inputdetails2(String uname) throws IOException, InterruptedException {
		pharmacistrole_click();
		addressline1_inputdata();
		city_inputdata() ;
		state_inputdata();
		zip_inputdata();
		choosepassword(uname);
		//cnfirmpassword();
		selectsecurityquestion1();
		securityanswer1();
		selectsecurityquestion2();
