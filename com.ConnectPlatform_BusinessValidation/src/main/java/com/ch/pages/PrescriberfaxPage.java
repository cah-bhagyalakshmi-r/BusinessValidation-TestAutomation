...
public class PrescriberfaxPage extends TestBase {
	...
	@FindBy(css = "#buildPreviewPDF")
	WebElement previewdocument;
	
	@FindBy(css = "#saveFinalPDF")
	...
	@FindBy(xpath = "/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/flux-card[1]/div[1]/select[1]")
	public WebElement rolelist;
	
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[2]/connect-platform-navigation/div/div[1]/div/div[1]/div[2]/flux-card/div/div/select")
	public WebElement rolelist2;
	
	@FindBy(xpath = "/html[1]/body[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/flux-card[1]/flux-card-header[1]/div[1]/div[1]")
	public WebElement switchroles;
	
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[2]/connect-platform-navigation/div/div[1]/div/div[1]/div[2]/flux-card/flux-card-header/div/div/div[1]")
	public WebElement switchroles1;
	...
	@FindBy(xpath = "/html/body/div[2]/div/div[1]/div/div[1]/div/flux-icon")
	WebElement usermenu;
	
	@FindBy(xpath = "/html/body/div[1]/div[1]/div[2]/connect-platform-navigation/div/div[1]/div/div[1]/div/flux-icon")
	...
	public void roleselect1(String roleselector) {
		Select rolesel = new Select(rolelist2);
		rolesel.selectByVisibleText(roleselector);
	}
	...
	public void prescriberfax_click() {
		prescriberfax.click();
	}
